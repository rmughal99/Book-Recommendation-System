...
@app.route('/')
def index():
    # Render the homepage with popular books
...
def recommend():
    ...
    # Check if the input book exists in the dataset
    if user_input not in pt.index:
        error_message = "The book you entered is not in the dataset. Please try another one."
